...
#ifdef __cplusplus
#define OS_LOG_API_BEGIN extern "C" {
#define OS_LOG_API_END }
#else
#define OS_LOG_API_BEGIN
#define OS_LOG_API_END
#endif

#if defined(WIN32) || defined(_WIN32)
#if defined(OS_LOG_API_EXPORT)
#define OS_LOG_API __declspec(dllexport)
#else
#define OS_LOG_API __declspec(dllimport)
#endif
#else
#define OS_LOG_API
#endif
...
* @return 0--成功 -1--失败
*/
OS_LOG_API int log_msg_init(const char * file, LOG_MSG_LEVEL level);

/*
* log_msg_uninit
* @brief  日志销毁
*/
OS_LOG_API void log_msg_uninit(void);
...
* @param  ms 切片时长
*/
OS_LOG_API void log_msg_set_slice_duration(size_t ms);
...
* @param  kb 大小
*/
OS_LOG_API void log_msg_set_slice_size(size_t kb);
...
* @param  fmt    日志格式
*/
OS_LOG_API int log_msg(LOG_MSG_LEVEL level, const char * file, int line, const char * func, const char * fmt, ...);
...
* @param  vl     日志参数表
*/
OS_LOG_API int log_msg_doit(LOG_MSG_LEVEL level, const char * file, int line, const char * func, const char * fmt, va_list vl);
